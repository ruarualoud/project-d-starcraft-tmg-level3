...
export type StarcraftTmgSecureProviderIntent =
  | { type: "load_profiles" }
  | { type: "prepare_attachment"; providerProfileRef: { id: string; version: string; hash: string }; consentAccepted: true }
...
export interface StarcraftTmgSecureProviderSession {
  ...
  dispatch(intent: StarcraftTmgSecureProviderIntent): Promise<StarcraftTmgSecureProviderResult>;
  subscribe(listener: (view: StarcraftTmgSecureProviderView) => void): () => void;
}
