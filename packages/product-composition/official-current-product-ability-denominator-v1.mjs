...
export const OFFICIAL_CURRENT_PRODUCT_ABILITY_DENOMINATOR_VERSION = "2.1.0";
...
const DELIVERY_SLICE_BY_ADAPTER = Object.freeze({
  ...
  "official-zerg-unique-family-adapter-v1": 241,
  "official-protoss-unique-family-adapter-v1": 242,
});
