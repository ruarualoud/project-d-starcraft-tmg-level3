...
const GAME_KEYS = new Set([
  ...
  "equipment", "equipmentKey", "equipmentName", "normalizedEquipmentName",
  "equipmentSourceKind", "equipmentProfileId", "replacementTargetName",
  "specialistLoadout", "weaponChoices", "assaultWeaponNames", "combatTags",
