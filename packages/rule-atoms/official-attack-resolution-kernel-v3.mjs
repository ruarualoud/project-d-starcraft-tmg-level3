...
export const OFFICIAL_ATTACK_RESOLUTION_KERNEL_V3_ID =
  "authority.attack-resolution-kernel-v3";
export const OFFICIAL_ATTACK_RESOLUTION_KERNEL_V3_VERSION = "3.0.0";
...
function planAttack(input) {
  ...
  const layout = {
    ...
    surge: surge ? 1 : 0,
    armour: rateOfAttack,
    evade: evadeEligibility.eligible ? rateOfAttack : 0,
  };
  const body = {
    schema: "starcraft_tmg_official_attack_resolution_plan_v3",
    kernelId: OFFICIAL_ATTACK_RESOLUTION_KERNEL_V3_ID,
    kernelVersion: OFFICIAL_ATTACK_RESOLUTION_KERNEL_V3_VERSION,
...
function resolveAttack(plan, reveals) {
  if (!object(plan)
    || plan.schema !== "starcraft_tmg_official_attack_resolution_plan_v3"
    || plan.kernelId !== OFFICIAL_ATTACK_RESOLUTION_KERNEL_V3_ID
    || plan.kernelVersion !== OFFICIAL_ATTACK_RESOLUTION_KERNEL_V3_VERSION
  ...
  const body = {
    schema: "starcraft_tmg_official_attack_resolution_receipt_v3",
    kernelId: OFFICIAL_ATTACK_RESOLUTION_KERNEL_V3_ID,
    kernelVersion: OFFICIAL_ATTACK_RESOLUTION_KERNEL_V3_VERSION,
...
export function createOfficialAttackResolutionKernelV3() {
  const descriptorBody = {
    schema: "starcraft_tmg_official_attack_resolution_kernel_descriptor_v3",
    kernelId: OFFICIAL_ATTACK_RESOLUTION_KERNEL_V3_ID,
    kernelVersion: OFFICIAL_ATTACK_RESOLUTION_KERNEL_V3_VERSION,
