// Explicit frozen v3 data rebind. V2 remains unchanged for historical replay.
// Only snapshot/dataset/bundle identities changed; Marine, TAF, Core and base-size
// source records remain byte-identical and are still checked below.
...
export const OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_ID =
  "authority.marine-optional-stimpack-move-v3";
export const OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_VERSION = "3.0.0";
export const OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_TRANSITION_SCHEMA =
  "starcraft_tmg_authority_v2.receipt";
export const OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_PARAMETER_KIND =
  "official_marine_optional_stimpack_move_path_v3";
export const OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_NEW_ATOM_IDS =
  Object.freeze([]);
export const OFFICIAL_MARINE_OPTIONAL_STIMPACK_BASE_MOVE_V3_ACTION_ATOM_IDS =
  Object.freeze([...OFFICIAL_STANDARD_MOVE_ACTION_ATOM_IDS]);
export const OFFICIAL_MARINE_OPTIONAL_STIMPACK_USE_MOVE_V3_ACTION_ATOM_IDS =
  Object.freeze([...OFFICIAL_STIMPACK_MOVE_ACTION_ATOM_IDS]);
export const OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_ATOM_IDS =
  Object.freeze([...new Set([
    ...OFFICIAL_MARINE_OPTIONAL_STIMPACK_BASE_MOVE_V3_ACTION_ATOM_IDS,
    ...OFFICIAL_MARINE_OPTIONAL_STIMPACK_USE_MOVE_V3_ACTION_ATOM_IDS,
...
const CURRENT_COMPREHENSIVE_GAMEPLAY_BUNDLE_HASH =
  "791e44d6c95acdd2ca1b944f5ccdf941f6bab37051b0a697814377eb4f5176ac";
const CURRENT_RESERVE_DATA_BUNDLE_HASH =
  "7134000b49696c72242af9173b5decbce3ca707dede6b83a9024691d55bbd361";
...
export function officialMarineOptionalStimpackMoveActionAtomIdsV3(moveMode) {
  if (moveMode === "base") {
    return OFFICIAL_MARINE_OPTIONAL_STIMPACK_BASE_MOVE_V3_ACTION_ATOM_IDS;
  }
  if (moveMode === "stimpack") {
    return OFFICIAL_MARINE_OPTIONAL_STIMPACK_USE_MOVE_V3_ACTION_ATOM_IDS;
  }
...
function domainFor(state, context, matchBinding, moveMode, stimpack = null) {
  ...
  const ruleAtomIds = officialMarineOptionalStimpackMoveActionAtomIdsV3(moveMode);
  ...
  const core = {
    ...
    parameterKind: OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_PARAMETER_KIND,
    ...
    executorId: OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_ID,
    executorVersion: OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_VERSION,
    ...
    constraints: {
      ...
      geometryScope:
        "current_marine_one_to_nine_models_empty_terrain_round_base_optional_stimpack_move_v3",
    },
...
function diagnostic(state, sideKey, moveMode, error) {
  return {
    ...
    moveMode,
    abilityChoice: moveMode === "stimpack" ? "use_before_move" : "decline",
    ruleAtomIds: [...officialMarineOptionalStimpackMoveActionAtomIdsV3(moveMode)],
    executorId: OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_ID,
    executorVersion: OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_VERSION,
    isEnabled: false,
...
export function enumerateOfficialMarineOptionalStimpackMoveV3(state, options = {}) {
...
function canonicalAction(domain, plan) {
  ...
  return {
    ...
    movePlan: clone(plan),
    ruleAtomIds: [...officialMarineOptionalStimpackMoveActionAtomIdsV3(domain.moveMode)],
    executorId: OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_ID,
    executorVersion: OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_VERSION,
  };
}

export function instantiateOfficialMarineOptionalStimpackMoveV3(
  state,
  domain,
  parameters,
  options = {},
  ...
  if (!object(domain)
    || domain.parameterKind !== OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_PARAMETER_KIND
    || domain.executorId !== OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_ID
    || domain.executorVersion !== OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_VERSION
    || !MOVE_MODES.includes(domain.moveMode)) {
    fail("OPTIONAL_STIMPACK_MOVE_PARAMETER_DOMAIN_INVALID");
  }
  const current = enumerateOfficialMarineOptionalStimpackMoveV3(state, {
    sideKey: domain.sideKey,
...
export function applyOfficialMarineOptionalStimpackMoveV3(
  stateInput,
  actionInput,
  options = {},
) {
  if (!object(actionInput)
    ...
    || actionInput.executorId !== OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_ID
    || actionInput.executorVersion
      !== OFFICIAL_MARINE_OPTIONAL_STIMPACK_MOVE_V3_EXECUTOR_VERSION
    || !MOVE_MODES.includes(actionInput.moveMode)
    || !object(actionInput.movePlan)) {
    fail("OPTIONAL_STIMPACK_MOVE_ACTION_INVALID");
  }
  const enumeration = enumerateOfficialMarineOptionalStimpackMoveV3(stateInput, {
  ...
  const instantiated = instantiateOfficialMarineOptionalStimpackMoveV3(
    stateInput,
    domain,
    {
