...
export const OFFICIAL_ATTACK_RESOLUTION_KERNEL_ID =
  "authority.attack-resolution-kernel-v1";
export const OFFICIAL_ATTACK_RESOLUTION_KERNEL_VERSION = "1.0.0";
...
function planAttack(input) {
  ...
  const body = {
    schema: "starcraft_tmg_official_attack_resolution_plan_v1",
    kernelId: OFFICIAL_ATTACK_RESOLUTION_KERNEL_ID,
    kernelVersion: OFFICIAL_ATTACK_RESOLUTION_KERNEL_VERSION,
...
function resolveAttack(plan, reveals) {
  if (!object(plan)
    || plan.schema !== "starcraft_tmg_official_attack_resolution_plan_v1"
    || plan.kernelId !== OFFICIAL_ATTACK_RESOLUTION_KERNEL_ID
    || plan.kernelVersion !== OFFICIAL_ATTACK_RESOLUTION_KERNEL_VERSION
  ...
  const stages = {
    ...
    damage: {
      damagePoolDice,
      damagePerDie: plan.profile.damage,
      totalDamage: damagePoolDice * plan.profile.damage,
    },
  };
  const body = {
    schema: "starcraft_tmg_official_attack_resolution_receipt_v1",
    kernelId: OFFICIAL_ATTACK_RESOLUTION_KERNEL_ID,
    kernelVersion: OFFICIAL_ATTACK_RESOLUTION_KERNEL_VERSION,
...
export function createOfficialAttackResolutionKernelV1() {
  const descriptorBody = {
    schema: "starcraft_tmg_official_attack_resolution_kernel_descriptor_v1",
    kernelId: OFFICIAL_ATTACK_RESOLUTION_KERNEL_ID,
    kernelVersion: OFFICIAL_ATTACK_RESOLUTION_KERNEL_VERSION,
    stages: ["declaration", "hit", "effects", "evade", "armour", "damage"],
