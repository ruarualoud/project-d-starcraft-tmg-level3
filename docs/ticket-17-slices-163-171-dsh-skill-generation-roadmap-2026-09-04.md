...
Date: 2026-09-04
Status: Slices 163–165 complete; Ticket 17 is 3/9
...
166 is the next dependency because DSH cannot be installed or run until the
disposable OS isolation and capability firewall fail closed behaviorally.
...
Slice 166 must prove an OS-enforced disposable runner behaviorally. If neither
a container/microVM nor a tested equivalent denies file, process and network
escape, DSH execution fails closed—there is no ordinary child-process fallback.
