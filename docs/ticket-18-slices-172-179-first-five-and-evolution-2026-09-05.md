...
Slice178 then compiled both patches into complete candidate Skills, passed each
on four old/new direction-specific Rules cases, rejected two fixed-first-actor
