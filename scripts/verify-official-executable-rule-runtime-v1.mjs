...
await check("runtime_binds_the_exact_cumulative_catalogue_and_known_executors", () => {
  ...
  assert.equal(rulesRuntime.descriptor.executableRuleAtomCount, 421);
  assert.equal(rulesRuntime.descriptor.nonExecutableRuleAtomCount, 605);
  ...
  assert.deepEqual(
    manifestById.get("authority.sidearm-pinpoint-ranged-batch-v1").actionTypes,
    ["ranged_attack"],
  );
  assert.deepEqual(
    manifestById.get("authority.goliath-scatter-ranged-batch-v1").actionTypes,
    ["ranged_attack"],
  );
  assert.deepEqual(
  ...
  assert.deepEqual(
    manifestById.get("authority.medic-life-support-reaction-v1").actionTypes,
  ...
  assert.deepEqual(
    manifestById.get("authority.stimpack-move-consumer-v1").actionTypes,
    ["move"],
  );
  assert.deepEqual(
  ...
  assert.deepEqual(
    manifestById.get("authority.start-of-round-v3").actionTypes,
    ["resolve_start_of_round"],
  );
  assert.deepEqual(
    manifestById.get("authority.reserve-deploy-v3").actionTypes,
    ["deploy"],
  );
  assert.deepEqual(
    manifestById.get("authority.standard-move-v3").actionTypes,
    ["move"],
  );
  assert.deepEqual(
    manifestById.get("authority.disengage-v3").actionTypes,
    ["disengage"],
  );
});
