...
const limits = { maxCalls: 8, maxCostMicros: 2_000_000, maxTokens: 4_000_000, maxWallMs: 30 * 60 * 1000, maxInputBytes: 1_000_000 };
const recipe = seal({ version: 'faction_dependency_recheck_run_v1', sourceRunId, sourceRecipeHash: parent.hash,
  ...
  limits, plannedReviewCalls: 2, scope: 'two_target_source_review_intervention_not_production_revision_or_skill_acceptance',
